...
public class LoggerExecutionContext
{
    ...
    public LoggerExecutionContext()
    {

    }

    public LoggerExecutionContext(Uri requestedURI, String requestMethod, string requestBody)
    {
    ...
    public LoggerExecutionContext(System.Net.HttpWebRequest request)
    {
...
public class ErrorReporter
{
        ...
        public static bool IsConfiguredAndEnabled()
    {
        ...
        if (AppID < 0)
            result = false;
        if (String.IsNullOrWhiteSpace(ErrorAPIWriteOnlyAccessCode))
            result = false;
        if (String.IsNullOrWhiteSpace(ErrorAPIEndpoint) && !ErrorLogUseSQLConnToReport)
            result = false;
    ...
    private static string GetSetting(string Key, string Default = null)
    {
        ...
        /*
        if (!String.IsNullOrWhiteSpace(AppConfigBranchForErrorLog)) 
        {
...
#region Without A Name (overloads)
    public static async Task<EventReporterResponse> ReportErrorLowSeverity(Exception exObj, ApplicationContext context = null, LoggerExecutionContext xContext = null)
    {
        return await ReportError(exObj, String.Empty, context, xContext, String.Empty, intSeverity: LowSeverity).ConfigureAwait(false);
    }

    public static async Task<EventReporterResponse> ReportErrorNormalSeverity(Exception exObj, ApplicationContext context = null, LoggerExecutionContext xContext = null)
    {
    ...
    public static async Task<EventReporterResponse> ReportErrorHighSeverity(Exception exObj, ApplicationContext context = null, LoggerExecutionContext xContext = null)
    {
        return await ReportError(exObj, String.Empty, context, xContext, String.Empty, intSeverity: HighSeverity).ConfigureAwait(false);
    }

    public static async Task<EventReporterResponse> ReportError(Exception exObj, ApplicationContext context = null, LoggerExecutionContext xContext = null, int? intSeverity = null)
    {
...
#region overloads
    public static async Task<EventReporterResponse> ReportErrorLowSeverity(Exception exObj, string strErrorName, ApplicationContext context = null, LoggerExecutionContext xContext = null, string strDetails = null, int? intDuration = null)
    {
    ...
    public static async Task<EventReporterResponse> ReportErrorNormalSeverity(Exception exObj, string strErrorName, ApplicationContext context = null, LoggerExecutionContext xContext = null, string strDetails = null, int? intDuration = null)
    {
    ...
    public static async Task<EventReporterResponse> ReportErrorHighSeverity(Exception exObj, string strErrorName, ApplicationContext context = null, LoggerExecutionContext xContext = null, string strDetails = null, int? intDuration = null)
    {
    ...
    public static async Task<EventReporterResponse> ReportError(Exception exObj, string strErrorName, ApplicationContext context = null, LoggerExecutionContext xContext = null, string strDetails = null, int? intSeverity = null, int? intDuration = null)
    {
                    ...
                    if (frames != null)
                    {
                        ...
                        foreach (System.Diagnostics.StackFrame frame in frames)
                        {
                            if (!String.IsNullOrWhiteSpace(frame.GetFileName()))
                            {
                                ...
                                if (String.IsNullOrWhiteSpace(req.CodeFileName))
...
#region Error Name
                                if (!String.IsNullOrWhiteSpace(strErrorName))
                                    strErrorName = strErrorName + " - " + exBase.Message;
                                else
                                    strErrorName = exBase.Message;
                                /*
                                if (String.IsNullOrWhiteSpace(strErrorName) && intLineNumber == 0)
                                    strErrorName = strSubject;
                                else if (String.IsNullOrWhiteSpace(strErrorName))
...
#region Email Subject
        ...
        if (!String.IsNullOrWhiteSpace(strSubjectComment))
...
#region PrefillEventModel
    public static ApplicationContext StartApplicationContext(ApplicationContext context = null)
    {
        if (context == null)
            context = new ApplicationContext();
        context.AppID = GetAppID(context);
    ...
    public static General.ErrorLogging.Model.ErrorOther PrefillEventModel(ref ApplicationContext context, string ErrorName, string Details = null, int? Severity = null, string MethodName = null, string FileName = null, System.Reflection.MethodBase CallingMethod = null, int? Duration = null)
    {
        ...
        context = StartApplicationContext(context);
...
#region GetAppName
    public static string GetAppName(ApplicationContext context)
    {
        ...
        if(AppID == 0 && General.ErrorLogging.Data.Application.HasErrorLogConnectionString) //Behavior for remote requests via API
        {
            try
            {
                if (String.IsNullOrWhiteSpace(strAppName) && context.AppID.HasValue)
                {
            ...
            if (String.IsNullOrWhiteSpace(strAppName))
            {
                ...
                if (System.Web.HttpContext.Current != null)
                {
                    try
                    {
                        ...
                        if (String.IsNullOrWhiteSpace(strAppName) || strAppName == "localhost")
                        {
