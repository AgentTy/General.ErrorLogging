...
ALTER TABLE [dbo].[ErrorOther] ALTER COLUMN [ClientID] varchar(50) 
ALTER TABLE [dbo].[ErrorOther] ALTER COLUMN [UserID] varchar(50)
ALTER TABLE [dbo].[ErrorOther] ALTER COLUMN [UserType] varchar(50)

ALTER TABLE [dbo].[Error404] ALTER COLUMN [ClientID] varchar(50)
ALTER TABLE [dbo].[Error404Redirect] ALTER COLUMN [ClientID] varchar(50)
