...
using General.ErrorLogging.GUI.Models;
...
namespace General.ErrorLogging.GUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            ...
            {
                if (model.AccessCode == Settings.AdminSignupAccessCode || String.IsNullOrWhiteSpace(Settings.AdminSignupAccessCode))
                { 
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Forgot(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                if (model.AccessCode == Settings.AdminSignupAccessCode || String.IsNullOrWhiteSpace(Settings.AdminSignupAccessCode))
