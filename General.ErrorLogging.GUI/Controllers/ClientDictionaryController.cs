...
namespace General.ErrorLogging.GUI.Controllers
{
    ...
    public class ClientDictionaryController : ApiController
    {

        #region GetAll
        // GET api/[AppID]/ClientDictionary
        [Authorize]
        public IEnumerable<string> GetAll(string AppID, bool ActiveOnly = true)
        {
            return General.ErrorLogging.Data.Application.GetClients(ParseAppID(AppID));
        }
        #endregion
        ...
        // GET api/[AppID]/ClientDictionary/Search?Search=test
        [HttpGet]
        [Authorize]
